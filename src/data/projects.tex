...
\noindent \href{https://github.com/Lucas-Pontes-Soares/learn-rabbitmq}{\bfseries RabbitMQ: Queues, Exchanges e DLQ} \hfill\ Abr 2026 \\
...
\noindent \href{https://github.com/Lucas-Pontes-Soares/estacao-agroclimatica-inteligente}{\bfseries Submissão Artigo na Revista InterAgro} \hfill\ Set 2025 -- Abr 2026 \\
...
\noindent \href{https://github.com/Lucas-Pontes-Soares/node-testable-apps}{\bfseries Back-end Node com Testes Unitários, Integração e E2E} \hfill\ Abr 2026 \\
...
\noindent \href{https://github.com/Lucas-Pontes-Soares/nest-library-api}{\bfseries Nest.JS Library API} \hfill\ Mar 2026 -- Abr 2026 \\
...
\begin{itemize}
    ...
    \item Estruturei uma matriz de permissões centralizada para gerenciar dinamicamente as ações permitidas a cada perfil de usuário.
\end{itemize}
\noindent {\bfseries Tecnologias:} Nest.js, Node.js, Typescript, Git, PostgreSQL, Drizzle, Roles, RBAC, ABAC, JWT.

%-----------------------------------------    
        
\noindent \href{https://github.com/Lucas-Pontes-Soares/devroast}{\bfseries DevRoast} \hfill\ Mar 2026 \\
...
\begin{itemize}
    ...
    \item Desenvolvi a camada de persistência e serviços back-end utilizando Node.js e banco de dados PostgreSQL;
    \item Implementei a lógica de análise estática e interpretativa de código conectando à API do Gemini;
    \item Programei as visualizações de métricas de qualidade, sugestões de correções e sistema de ranqueamento.
\end{itemize}
\noindent {\bfseries Tecnologias:} Next.js, Node.js, IA, Gemini, Claude Code, MCP, Git, Agentes, Typescript, tailwind-css, Pencil, Base-ui, PostgreSQL.

%-----------------------------------------    
        
\noindent \href{https://github.com/Lucas-Pontes-Soares/masterclass-nestjs}{\bfseries MasterClass Nest.js} \hfill\ Mar 2026 \\
...
\end{itemize}
\noindent {\bfseries Tecnologias:} Nest.js, Typescript, Node.js, Prisma, SQLite, Git.

%-----------------------------------------    
        
\noindent \href{https://github.com/Lucas-Pontes-Soares/learn-rag}{\bfseries Práticas de RAG} \hfill\ Mar 2026 \\
...
\noindent \href{https://github.com/Lucas-Pontes-Soares/learn-redis}{\bfseries Cache com Redis em Node.js} \hfill\ Mar 2026 \\
...
\noindent \href{https://github.com/Lucas-Pontes-Soares/desafio-microsservicos-escalaveis-Node.js}{\bfseries Desafio Microsserviços Escaláveis Node.js} \hfill\ Fev 2026 \\
...
\noindent \href{https://github.com/Lucas-Pontes-Soares/dumble}{\bfseries Dumble: Sistema Educacional Com Inteligência Artificial} \hfill\ Fev 2025 -- Dez 2025 \\
...
\noindent \href{https://github.com/Lucas-Pontes-Soares/JanelaAutomatica}{\bfseries Janela Automática} \hfill\ Set 2025 -- Dez 2025 \\
...
\noindent \href{https://github.com/Lucas-Pontes-Soares/avanti-intelligence}{\bfseries Avanti Intelligence: IA para detectar pneumonia} \hfill\ Mai 2025 -- Out 2025 \\
...
\noindent \href{https://github.com/Lucas-Pontes-Soares/atividade-interdisciplinar-kubernetes}{\bfseries Projeto Kubernetes Azure} \hfill\ Out 2025 \\
...
\begin{itemize}
    ...
    \item Gerei e publiquei a imagem de produção estruturada no Docker Hub;
...
\noindent \href{https://github.com/Lucas-Pontes-Soares/jogo-da-velha-com-ia}{\bfseries Jogo da Velha com IA} \hfill\ Set 2025 \\
...
\noindent \href{https://github.com/Lucas-Pontes-Soares/mini-site-docker}{\bfseries Jornal Docker} \hfill\ Set 2025 \\
...
\noindent \href{https://github.com/Lucas-Pontes-Soares/wine-quality}{\bfseries WineQuality: Machine Learning, Árvore de Decisão para Classificar Vinhos} \hfill\ Jun 2025 \\
...
\noindent \href{https://github.com/Lucas-Pontes-Soares/wine-quality}{\bfseries MazeSolver: Resolução de Labirinto com Busca Cega} \hfill\ Mai 2025 \\
...
\noindent \href{https://github.com/Lucas-Pontes-Soares/games-spring}{\bfseries Games Spring} \hfill\ Jan 2025 \\
...
\noindent \href{https://github.com/Lucas-Pontes-Soares/CETAF}{\bfseries CETAF} \hfill\ Out 2024 -- Dez 2024 \\
...
\noindent \href{https://github.com/Lucas-Pontes-Soares/ListagemPersonagens}{\bfseries Lista Personagens} \hfill\ Out 2024 -- Dez 2024 \\
...
\noindent \href{https://github.com/Lucas-Pontes-Soares/NLW-Expert}{\bfseries Notes} \hfill\ Fev 2024 \\
...
\noindent \href{https://github.com/Lucas-Pontes-Soares/NewsBlog}{\bfseries NewsBlog} \hfill\ Fev 2024 \\
...
\noindent \href{https://github.com/Lucas-Pontes-Soares/ListaCompras}{\bfseries Lista de Compras} \hfill\ Jan 2024 \\
...
\noindent \href{https://github.com/Lucas-Pontes-Soares/memoteca}{\bfseries Memoteca} \hfill\ Jan 2024 \\
...
\noindent \href{https://github.com/Lucas-Pontes-Soares/alurabooks}{\bfseries AluraBooks} \hfill\ Jan 2024 \\
...
\noindent \href{https://github.com/Lucas-Pontes-Soares/todolist}{\bfseries Java com Spring Boot} \hfill\ Out 2023 \\
...
\noindent \href{https://github.com/Lucas-Pontes-Soares/ProjetoTCC}{\bfseries GPLink} \hfill\ Fev 2023 -- Out 2023 \\
...
\noindent \href{https://github.com/Lucas-Pontes-Soares/NLW-IA}{\bfseries Upload AI} \hfill\ Set 2023 \\
...
\noindent \href{https://github.com/Lucas-Pontes-Soares/LaCafezito}{\bfseries La Cafezito} \hfill\ Set 2022 -- Dez 2022 \\
...
\noindent \href{https://github.com/Lucas-Pontes-Soares/ArduinoCancela}{\bfseries Cancela Automatica} \hfill\ Fev 2022 -- Out 2022 \\
...
\noindent \href{https://github.com/Lucas-Pontes-Soares/JogoAlvo}{\bfseries Jogo Tiro ao Alvo} \hfill\ Abr 2022 \\
...
\noindent \href{https://github.com/Lucas-Pontes-Soares/JogoForca}{\bfseries Jogo da Forca} \hfill\ Out 2021 -- Dez 2021 \\
